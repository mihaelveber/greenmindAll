<template>
  <div class="esrs-container">
    ...
    <div class="mobile-header">
      ...
      <n-h3 style="margin: 0; flex: 1; text-align: center;">ESRS Standards</n-h3>
    ...
    <n-drawer v-model:show="showMobileMenu" :width="280" placement="left">
      <n-drawer-content title="ESRS Standards" :native-scrollbar="false">
        <n-spin :show="loading">
    ...
    <n-layout has-sider>
      ...
      >
        <div class="sidebar-header">
          <n-space align="center" :size="12">
            ...
            <n-h3 style="margin: 0;">ESRS Standards</n-h3>
          </n-space>
        </div>
      ...
      <n-layout-content content-style="padding: 24px;">
        <n-card v-if="!selectedStandard" :bordered="false">
          <n-empty
            description="Select an ESRS standard from the sidebar to view disclosure requirements"
            size="large"
          >
            <template #icon>
...
const loadCategories = async () => {
  try {
    const response = await api.get('/esrs/categories')
    categories.value = response.data
  } catch (error) {
    message.error('Failed to load ESRS categories')
  }
}
...
const loadStandardDetails = async (standardId: number) => {
  try {
    ...
    message.error('Failed to load standard details')
  } finally {
